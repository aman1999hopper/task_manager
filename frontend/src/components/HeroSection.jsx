const HeroSection = () => {
  return (
    <section className="bg-white dark:bg-gray-900 pt-24"> {/* Added pt-24 for top padding */}
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-12">
        ...
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <div className="space-x-4">
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-blue-500 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            >
              Speak to Sales
            </a>
          </div>
